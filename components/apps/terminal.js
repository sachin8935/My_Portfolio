    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">Sachin@linux</div>
    ...
    switch (main) {
      ...
      case "ls":
        ...
        if (target in this.child_directories) {
          ...
          result =
            "Nope! 🙃 they are my personal😏 (Dont be smart using 'sudo' command)";
          break;
        } else {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/sachin");
        break;
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-gopi, trash, settings, sendmsg]";
        }
        break;
      case "echo":
